...
end_time = time.time()
print(f'SARSA for Pendulum problem - Total time taken: {end_time - start_time:.2f} seconds')
...
plt.legend()
plt.savefig("figures/pendulum/sarsa_learning_curves_alpha2.png")
#plt.show()
...
plt.legend()
plt.savefig("figures/pendulum/sarsa_learning_curves_epsilon2.png")
#plt.show()
...
plt.title('SARSA - Pendulum - Trajectory')
plt.legend(['s', 'a', 'r'])
plt.savefig('figures/pendulum/sarsa_policy_vs_trajec.png')
#plt.show
...
plt.legend()
plt.savefig("figures/pendulum/ql_learning_curves_alpha2.png")
#plt.show()
...
plt.legend()
plt.savefig("figures/pendulum/ql_learning_curves_epsilon2.png")
#plt.show()
...
plt.plot(log['t'][:-1], log['a'])
plt.plot(log['t'][:-1], log['r'])
plt.title('Q-Learning - Pendulum - Trajectory')
plt.legend(['s', 'a', 'r'])
plt.savefig('figures/pendulum/ql_policy_vs_trajec.png')
#plt.show